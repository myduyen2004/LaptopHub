    ...
    <body>
        ...
        <div>
            ...
            <div class="info">
                <div class="left-side">
                    <ul>
                        <a href="./profile"><li class="your-account">Tài Khoản Của Bạn</li></a>
                        <a href="./profile?cmd=load"><li>Cập Nhật Thông Tin Cá Nhân</li></a>
                        <a href="./cart?cmd=show&action=showcart"><li>Giỏ Hàng Của Bạn</li></a>
                        <a href="./payment"><li>Cập Nhật Số Dư</li></a>
