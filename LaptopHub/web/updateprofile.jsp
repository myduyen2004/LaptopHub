    ...
    <body>
        ...
        <div>
            ...
            <div class="info">
                <div class="left-side">
                    <ul>
                        <a href="./profile"><li>Tài Khoản Của Bạn</li></a>
                        <a href="./cart?cmd=show&action=showcart"><li class="update">Cập Nhật Thông Tin Cá Nhân</li></a>
                        <a href="./cart?action=showcart"><li>Giỏ Hàng Của Bạn</li></a>
