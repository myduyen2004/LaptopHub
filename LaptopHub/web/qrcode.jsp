                ...
                <div class="row">
                    <div class="col-12">
                        <div class="error_form">
                            <h2 class="text-center text-dark">Thanh toán hoá đơn: #${idtrans}!</h2>
                            <h4 class="text-center">Số tiền thanh toán: ${total} VND</h4>
                            <h4 class="text-center">Vui lòng viết ghi chú: </h4>
                            <h5 class="text-center" style="color: red">" Mã đơn hàng #${idtrans} "</h5>
                            <h6 class="text-center">Chúng tôi sẽ kiểm tra và thông báo đến bạn khi thanh toán hoàn tất !</h6>
                            <div class="text-center">
                                <iframe style="align-content: center;"height="650px" width="450px" src="images/others/momo-qr.jpg"></iframe>
                            </div>
